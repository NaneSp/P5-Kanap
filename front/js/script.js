...
fetch("http://localhost:3000/api/products")
  ...
  .then(function (apiArticles) {
    //console.log(apiArticles);//retourne en réponse un tableau contenant plusieurs articles
    showItems(apiArticles); //exécution de la function
  })
...
//création de la fonction showItems
function showItems(apiArticles) {
