...
//promesse faite à l'api si succès:
    ...
    .then (function(apiArticles){
        ...
        const itemsLink = 
        document.createElement("a");// créé un élement lien
        ...
        const itemsArticle = // fait apparaitre carte bleue foncée ds navigateur
        document.createElement("article");
        itemsLink.appendChild(itemsArticle);
        

        const itemsImg = // fait apparaitre contours blancs dans la carte itemsArticle
    ...
    //si erreur retourne le mot Erreur 
    alert("Erreur"); 
    })
