    ...
    for (let article in cartLS) {
     ...
     // console.log(id);// retroune bien les id des produits du LS
        ...
        response.json().then(async (data) => {
          ...
          /**********************************FIN Calcul de la quantité totale *********************************/
        ...
        /**************************Modification de la quantité depuis la page panier***************************/
        const inputQuantity = document.querySelector(".itemQuantity");
        //console.log(inputQuantity);// retourne l'input 

            
        /************************* FIN Modification de la quantité depuis la page panier**********************/    
        ...
        const deleteItem = document.querySelector(".cart__item__content__settings__delete");
        //console.log(deleteItem);// retourne bien les possibilité de suppression du dom
        ...
        /*************************** FIN Suppression des articles depuis la page panier************************/
        })
    );
}
...
const validaddress = function (inputaddress) {
    ...
    let addressRegExp = new RegExp(
      "^[a-zA-ZÀ-ÖØ-öø-ÿ0-9-,'°\s*]+$","g"  ///////attention revoir les espaces pour adresse valide
    );
